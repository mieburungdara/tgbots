...
$router->get('xoradmin/file_error_log', 'Admin/LogController@fileErrorLog'); // New route
...
$router->post('api/xoradmin/bots/set-webhook', 'Admin/BotApiController@setWebhook');
