...
CREATE TABLE `users`  (
  ...
  `public_seller_id` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ID publik untuk penjual',
  `seller_package_sequence` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Urutan paket penjual',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menyimpan informasi bot yang terhubung.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `api_request_logs`  (
  ...
  `method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Metode API yang dipanggil',
  `request_payload` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Payload request yang dikirim',
  `response_payload` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Payload response yang diterima',
...
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Mencatat semua request API yang dilakukan ke Telegram.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `app_logs`  (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp COMMENT 'Waktu pembuatan log',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 612 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Menyimpan log aplikasi internal.' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Mencatat riwayat penyesuaian saldo oleh admin.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `private_channels`  (
  ...
  `name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT 'Nama channel',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = 'Menyimpan daftar channel pribadi untuk penggunaan internal.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bot_channel_usage`  (
  `bot_id` bigint NOT NULL COMMENT 'ID bot yang menggunakan channel',
  `last_used_channel_id` int NOT NULL COMMENT 'ID channel terakhir yang digunakan',
...
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = 'Mencatat channel mana yang terakhir digunakan oleh bot.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bot_settings`  (
  ...
  `setting_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Kunci pengaturan',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menyimpan pengaturan kunci-nilai untuk setiap bot.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `members`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL COMMENT 'Referensi ke tabel users',
  `login_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Token untuk login',
  `token_created_at` timestamp NULL DEFAULT NULL COMMENT 'Waktu pembuatan token',
  `token_used` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Apakah token sudah digunakan',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menyimpan data member (pengguna yang terautentikasi).' ROW_FORMAT = Dynamic;
...
CREATE TABLE `messages`  (
  ...
  CONSTRAINT `fk_messages_bot` FOREIGN KEY (`bot_id`) REFERENCES `bots`(`id`) ON DELETE SET NULL
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menyimpan riwayat pesan yang masuk dan keluar.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `migrations`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `migration_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nama file migrasi',
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Mencatat migrasi database yang telah dijalankan.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `raw_updates`  (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp COMMENT 'Waktu pembuatan record',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 222 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Menyimpan semua update mentah yang diterima dari Telegram.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rel_user_bot`  (
  ...
  `bot_id` bigint NOT NULL COMMENT 'ID bot',
  `is_blocked` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0: tidak diblokir, 1: diblokir',
  `last_interaction_at` timestamp NULL DEFAULT NULL COMMENT 'Waktu interaksi terakhir',
  ...
  CONSTRAINT `fk_rel_bot` FOREIGN KEY (`bot_id`) REFERENCES `bots`(`id`) ON DELETE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menghubungkan pengguna dengan bot dan menyimpan status interaksi.' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menyimpan daftar peran pengguna.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `seller_sales_channels`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `seller_user_id` bigint NOT NULL COMMENT 'ID penjual',
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Menyimpan channel penjualan untuk setiap penjual.' ROW_FORMAT = Dynamic;
...
CREATE TABLE `telegram_error_logs`  (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'Deskripsi error',
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'failed' COMMENT 'Status penanganan error',
...
CREATE TABLE `user_roles`  (
  `user_id` bigint NOT NULL COMMENT 'ID pengguna',
  `role_id` int NOT NULL COMMENT 'ID peran',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Menghubungkan pengguna dengan peran mereka.' ROW_FORMAT = Dynamic;
