            ...
            <?php if ($current_log_file): ?>
                <div class="log-viewer-header">
                    ...
                    <?php if ($data['raw_log_content'] !== ''): ?>
                        <form action="<?= BASE_URL ?>xoradmin/file_logs/clear/<?= base64_encode($current_log_file) ?>" method="post" onsubmit="return confirm('Anda yakin ingin MENGHAPUS SEMUA isi log file ini? Aksi ini tidak dapat diurungkan.');">
